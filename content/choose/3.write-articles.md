...
For your article to be correctly displayed in the [articles list](/choose), define a `cover` and `date` property in the frontmatter:
...
```md[content/choose/1.my-new-article.md]
---
cover: path/to/cover
date: 2022-08-23
title: Another title
